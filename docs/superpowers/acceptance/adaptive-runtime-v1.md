...
| ---- | -------------- | ---------- | ------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| G1   | `c00d5e873c`   | 2026-07-20 | pending | 待用户生成 `g1-evidence/`；自动化产物为 `packages/opencode/dist/opencode-linux-x64/bin/opencode` | packaged offline smoke 已通过；真实模型试跑待用户执行 |
| G2   |                |            | blocked |                                                                                                  |                                                       |
| G3   |                |            | blocked |                                                                                                  |                                                       |
| G4   |                |            | blocked |                                                                                                  |                                                       |
| G5   |                |            | blocked |                                                                                                  |                                                       |
